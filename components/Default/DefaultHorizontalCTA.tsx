export const DefaultHorizontalCTA = () => {
  return (
    <div className="px-4 py-16 mb-8 mx-auto sm:max-w-xl  md:px-24 lg:px-8 lg:py-8 bg-slate-600 rounded-b-lg">
      <div className="grid gap-10 lg:grid-cols-1">
        <div className="lg:flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">

          <div className="max-w-xl  bg-slate-400 p-4  h-[400px] justify-between">
          ...
          <div className="flex items-center justify-center -mx-4 lg:pl-8 pt-3">
